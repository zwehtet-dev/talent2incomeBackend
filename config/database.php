    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'talent2income'),
        ...
        'mysql_read' => [
            ...
            'database' => env('DB_READ_DATABASE', env('DB_DATABASE', 'talent2income')),
        ...
        'mysql_testing' => [
            ...
            'database' => env('DB_TEST_DATABASE', 'talent2income_test'),
    ...
    */
    ...
    'redis' => [
        ...
        'search' => [
            ...
            'password' => env('REDIS_PASSWORD'),
            'port' => env('REDIS_PORT', '6379'),
            'database' => env('REDIS_SEARCH_DB', '5'),
        ],
